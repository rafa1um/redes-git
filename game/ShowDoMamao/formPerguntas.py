...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lcdTimer.setGeometry(QtCore.QRect(410, 30, 64, 23))
        font = QtGui.QFont()
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(75)
        self.lcdTimer.setFont(font)
        self.lcdTimer.setProperty("value", 10.0)
